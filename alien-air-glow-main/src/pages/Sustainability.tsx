...
const points = [
  ...
  { icon: Leaf, title: "Long-Life Filters", desc: "Our HEPA and activated carbon filters last up to 6 months before replacement, reducing waste and lowering long-term cost." },
