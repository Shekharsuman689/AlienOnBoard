...
const features = [
  { icon: Shield, title: "HEPA Filtration", desc: "Removes 99% of dust, pollen, and airborne particles with medical-grade HEPA technology." },
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-lg mb-8 leading-relaxed">
              AlienOnBoard removes dust, pollutants, and allergens from your indoor air using advanced HEPA and activated carbon filtration — all in a sleek, portable design.
            </p>
